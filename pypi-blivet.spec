...
Source0  : https://files.pythonhosted.org/packages/4e/51/40829ed261994ccc9618604fc72df7f817955a648eded0a7ab66e39ce477/blivet-3.9.2.tar.gz
...
%prep
%setup -q -n blivet-3.9.2
cd %{_builddir}/blivet-3.9.2
pushd ..
cp -a blivet-3.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711726012
