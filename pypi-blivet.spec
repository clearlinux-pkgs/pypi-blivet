...
Version  : 3.6.1
Release  : 34
URL      : https://files.pythonhosted.org/packages/5a/bd/44f5eee57eb2a05b49340e6768a98e54d93738d1cf9ac35f67664d34f37c/blivet-3.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/5a/bd/44f5eee57eb2a05b49340e6768a98e54d93738d1cf9ac35f67664d34f37c/blivet-3.6.1.tar.gz
...
%prep
%setup -q -n blivet-3.6.1
cd %{_builddir}/blivet-3.6.1
pushd ..
cp -a blivet-3.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669819403
