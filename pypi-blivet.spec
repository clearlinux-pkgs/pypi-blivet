...
Version  : 3.4.4
Release  : 24
URL      : https://files.pythonhosted.org/packages/31/d4/8a1626f1cfb4125512cd40ae1c962079d1de1b8dfcf239acfb274861269a/blivet-3.4.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/31/d4/8a1626f1cfb4125512cd40ae1c962079d1de1b8dfcf239acfb274861269a/blivet-3.4.4.tar.gz
...
%prep
%setup -q -n blivet-3.4.4
cd %{_builddir}/blivet-3.4.4
pushd ..
cp -a blivet-3.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656361698
...
cp %{_builddir}/blivet-3.4.4/COPYING %{buildroot}/usr/share/package-licenses/pypi-blivet/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/blivet-3.4.4/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pypi-blivet/01a6b4bf79aca9b556822601186afab86e8c4fbf
