...
Source0  : https://files.pythonhosted.org/packages/00/f4/15812903f6ceb3563754ffe3f43a1473a58da59265235cbea1c6d8edcbaf/blivet-3.10.0.tar.gz
...
%prep
%setup -q -n blivet-3.10.0
cd %{_builddir}/blivet-3.10.0
pushd ..
cp -a blivet-3.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715352610
