...
Source0  : https://files.pythonhosted.org/packages/9a/a5/7f9a26838da0f27e57fe14fa88a54e5396fb3155cdb35dea88b29f2fd0bc/blivet-3.4.1.tar.gz
...
%prep
%setup -q -n blivet-3.4.1
cd %{_builddir}/blivet-3.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629407166
...
cp %{_builddir}/blivet-3.4.1/COPYING %{buildroot}/usr/share/package-licenses/blivet/4cc77b90af91e615a64ae04893fdffa7939db84c
